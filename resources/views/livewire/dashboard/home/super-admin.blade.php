                ...
                <div class="row g-5 g-xl-8">
                    <div class="col-xl-3">
                        ...
                        <a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-inverse-dark fw-bolder fs-2 mb-2 mt-5">{{$totalUsers}}</div>
                                <div class="fw-bold text-inverse-dark fs-7">{{__('Total Users')}}</div>
                    ...
                    <div class="col-xl-3">
                        ...
                        <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                            <!--begin::Body-->
                            <div class="card-body">
                                <!--begin::Svg Icon | path: assets/media/icons/duotone/General/Thunder-move.svg-->
                                <span class="svg-icon svg-icon-muted svg-icon-2hx"><svg
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-inverse-info fw-bolder fs-2 mb-2 mt-5">{{$totalCards}}</div>
                                <div class="fw-bold text-inverse-info fs-7">{{__("Total Cards")}}</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
                    ...
                    <div class="col-xl-3">
                        ...
                        <a href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                            <!--begin::Body-->
                            <div class="card-body">
                                <!--begin::Svg Icon | path: assets/media/icons/duotone/General/Binocular.svg-->
                                <span class="svg-icon svg-icon-muted svg-icon-2hx"><svg
                                        xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-inverse-warning fw-bolder fs-2 mb-2 mt-5">{{$totalPendingMessages}}
                                </div>
                                <div class="fw-bold text-inverse-warning fs-7">{{__("Total Pending Messages")}}</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
                    ...
                    <div class="col-xl-3">
                        ...
                        <a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-inverse-info fw-bolder fs-2 mb-2 mt-5">0
                                </div>
                                <div class="fw-bold text-inverse-info fs-7">{{__("Total Accept Experiences")}}</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
