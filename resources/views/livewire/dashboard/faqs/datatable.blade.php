    ...
    <div class="card card-flush mt-6 mt-xl-9">
        ...
        <div class="card-header mt-5">
            <div class="card-title flex-column">
                <h3 class="fw-bolder mb-1">{{__("FAQs")}}</h3>
                    ...
                    <table
                        ...
                        <thead class="fs-7 text-gray-400 text-uppercase">
                            <tr role="row">
                                ...
                                <th wire:click="sortBy('question')" data-sort="{{$sortDirection}}" class="min-w-50px">
                                    {{__("Question")}}
                                    <x-sort field="question" sortBy="{{$sortBy}}" sortDirection="{{$sortDirection}}">
                                    </x-sort>
                                </th>
                                <th wire:click="sortBy('answer')" data-sort="{{$sortDirection}}" class="min-w-50px">
                                    {{__("Answer")}}
                                    <x-sort field="answer" sortBy="{{$sortBy}}" sortDirection="{{$sortDirection}}">
                                    </x-sort>
                                </th>
                            ...
                            <tr wire:loading.class="opacity-50">
                                ...
                                <td>
                                    <div class="d-flex justify-content-end flex-shrink-0">
                                        <x-edit-button href="{{route('admin.faqs.edit',$faq)}}"/>
                                        <x-delete-record-button wire:click="confirm({{ $faq->id }})"/>
                                    </div>
                                </td>
                            </tr>
                            @empty
