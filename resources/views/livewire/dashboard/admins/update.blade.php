    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">{{__("Update Admin")}}</h3>
            </div>
        </div>
        <div id="kt_account_profile_details" class="collapse show">
            <form class="form">
                <div class="card-body border-top p-9">
                    <!--begin::Input group-->
                    <div class="row mb-6">
                        <x-label class="required">{{__("Admin Name")}}</x-label>
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
                                    <x-input type="text" field="admin.name" wire:model="admin.name" placeholder="name" />
                                </div>
                    ...
                    <!--begin::Input group-->
                    <div class="row mb-6">
                        <x-label>{{__("Number of Employees")}}</x-label>
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
                                    <x-input type="number" field="admin.no_of_employees" wire:model="admin.no_of_employees" placeholder="no_of_employees" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-0">
                        <!--begin::Label-->
                        <label class="col-lg-4 col-form-label fw-bold fs-6 mt-4">{{__("Logo")}}</label>
                        <!--begin::Label-->
                        <!--begin::Label-->
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="col-12" x-data="{ isUploading: false, progress: 0 }"
                                ...
                                <label for="icon"
                                    ...
                                    <x-input type="file" id="logo" wire:model.lazy="logo" field="logo"
                                        style="display:none" />
                                </label>
