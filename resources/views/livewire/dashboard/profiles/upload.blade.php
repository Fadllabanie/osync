    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">{{__("Upload Profiles")}}</h3>
            </div>
        </div>
            ...
            <form class="form">
                <div class="card-body border-top p-9">
                  ...
                  <!--begin::Input group-->
                    <div class="row mb-0">
                        <!--begin::Label-->
                        <label class="col-lg-4 col-form-label fw-bold fs-6 mt-4 required">{{__("File")}}</label>
                        <!--begin::Label-->
                        <!--begin::Label-->
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="col-12" x-data="{ isUploading: false, progress: 0 }"
                                ...
                                <label for="icon"
                                    ...
                                    <x-input type="file" id="icon" wire:model.lazy="file" field="file"
                                        style="display:none" />
                                </label>
