    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">{{__("Create Subcategory")}}</h3>
            </div>
        </div>
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <div wire:ignore>
                                <select wire:model="category_id" id="category_id" name="category_id" data-control="select2"
                            ...
                            <x-error-select field="category_id" />
                        </div>
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                    ...
                    <div class="row mb-0">
                        <!--begin::Label-->
                        <x-label class="required">{{__("Icon")}}</x-label>
                        <!--begin::Label-->
                        <!--begin::Label-->
