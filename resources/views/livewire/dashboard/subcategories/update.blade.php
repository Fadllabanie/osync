                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row" wire:ignore>
                            <select wire:model="category_id" data-control="select2" id="category_id"
                                name="category_id" class="form-select form-select-solid form-select-lg fw-bold">
                        ...
                        <x-error field="subcategory.category_id" />
                    </div>
                    <!--end::Input group-->
                    <!--begin::Input group-->
                    <div class="row mb-6">
                        <x-label class="required">{{__("Subcategory Name")}}</x-label>
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
                                    <x-input type="text" field="subcategory.name" wire:model="subcategory.name"
                                        placeholder="name" />
                                </div>
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="col-12" x-data="{ isUploading: false, progress: 0 }"
                                ...
                                <div class="symbol symbol-150 mt-5">
                                    <img alt="" src="{{ asset($subcategory->icon) }}" />
                                </div>
                                @endif
                            </div>
                        </div>
